<?php
	...
	if(!$query_res){
		...
		$query2 = "INSERT INTO Anagrafe (mailutente, datanascita, cittanascita, sesso, viaresidenza, cittaresidenza, provinciaresidenza, statoresidenza) VALUES ('".$Mail."','".$DataN."','".$CittaN."','".$Sesso."','".$ViaR."','".$CittaR."','".$ProvR."','".$StatoR."')";
