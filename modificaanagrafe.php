<?php
	...
	$ViaR = pg_escape_string($_POST['ViaR']);
	...
	if(!pg_fetch_array($query_empty_res)) {
		...
		$query_insert = " INSERT INTO anagrafe (mailutente, datanascita, cittanascita, sesso, viaresidenza, cittaresidenza, provinciaresidenza, statoresidenza) VALUES ('".$usr."','".$DataN."','".$CittaN."','".$Sesso."','".$ViaR."','".$CittaR."','".$ProvinciaR."','".$StatoR."') ";
