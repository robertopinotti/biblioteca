  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        $query_prestiti_passati = "SELECT * FROM prestito p JOIN copia c ON p.nRegCopia=c.nReg JOIN libro l ON c.edizioneLibro=l.edizione AND c.isbnLibro=l.isbn WHERE dataFine IS NOT null ";

        if($query_prestiti_passati = @pg_query(" SELECT * FROM prestito p JOIN copia c ON p.nRegCopia=c.nReg JOIN libro l ON c.edizioneLibro=l.edizione AND c.isbnLibro=l.isbn WHERE dataFine IS NOT null")){
