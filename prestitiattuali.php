  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        $query = "SELECT p.mailutente, l.titolo, l.isbn, l.edizione, p.datainizio, c.nreg FROM prestito p JOIN copia c ON p.nRegCopia=c.nReg JOIN libro l ON c.edizioneLibro=l.edizione AND c.isbnLibro=l.isbn WHERE dataInizio IS NOT NULL AND dataFine IS null EXCEPT(
                SELECT ute.mail, lib.titolo, lib.isbn, lib.edizione, pre.datainizio, cop.nreg
                FROM
                ((((
                ...
                WHERE
                (((pre.datainizio + per.tempoprestito) < 'now()') AND (pre.datafine IS NULL)) ) ";
