...
<ul class="breadcrumb">
  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      ...
      $query = "SELECT DISTINCT mailUtente, nregcopia, titolo
      ...
      if($query_res){
        ...
        echo "<thead><tr>";
        echo "<td><b>ciao mail utente</b></td>";
        echo "<td><b>titolo libro</b></td>";
        echo "<td><b>numero copia libro</b></td>";
        echo "<td><b>convalida prestito</b></td>";
        echo "</thead></tr>";
        ...
        while ($row = pg_fetch_array($query_res)) {
          ...
          echo "<td>".$Titolo."</td>";
          echo "<td>".$NReg."</td>";
          echo "<td><a href='convalidaprestito.php?Mail=".$Mail."&NReg=".$NReg."'>CONVALIDA PRESTITO</a></td>";
          echo "</tbody></tr>";
