  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        $query_anagrafe_utente = "SELECT * FROM prestito p JOIN copia c ON p.nRegCopia=c.nReg JOIN libro l ON c.edizioneLibro=l.edizione AND c.isbnLibro=l.isbn WHERE mailUtente='$usr' AND dataFine IS null ";

        if($query_anagrafe_utente = @pg_query(" SELECT * FROM prestito p JOIN copia c ON p.nRegCopia=c.nReg JOIN libro l ON c.edizioneLibro=l.edizione AND c.isbnLibro=l.isbn WHERE mailUtente='$usr' AND dataFine IS null ")){
  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        $query_anagrafe_utente = "SELECT * FROM prestito p JOIN copia c ON p.nRegCopia=c.nReg JOIN libro l ON c.edizioneLibro=l.edizione AND c.isbnLibro=l.isbn WHERE mailUtente='$usr' AND dataFine IS NOT null ";

        if($query_anagrafe_utente = @pg_query(" SELECT * FROM prestito p JOIN copia c ON p.nRegCopia=c.nReg JOIN libro l ON c.edizioneLibro=l.edizione AND c.isbnLibro=l.isbn WHERE mailUtente='$usr' AND dataFine IS NOT null")){
