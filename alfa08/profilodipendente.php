  ...
  <div class="col-md-6">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="URL">
          <button type="submit" class="btn btn-primary btn-block" disabled="disabled">ELIMINA LIBRO</button>
        </form>
  ...
  <div class="col-md-6">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="URL">
          <button type="submit" class="btn btn-primary btn-block" disabled="disabled">CONVALIDA PRESTITO</button>
        </form>

        <br/>

        <form action="URL">
          <button type="submit" class="btn btn-primary btn-block" disabled="disabled">TERMINA PRESTITO</button>
        </form>

        <br/>

        <form action="URL">
          <button type="submit" class="btn btn-primary btn-block" disabled="disabled">PRESTITI PASSATI</button>
        </form>
