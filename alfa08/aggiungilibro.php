...
$query1 = "INSERT INTO Libro (titolo, edizione, isbn, nomecasaeditrice, datapubblicazione) VALUES ('".$Titolo."','".$Edizione."','".$Isbn."','".$CasaEd."','".$DataP."')";
$query_res1 = pg_query($con, $query1);

$queryA = "INSERT INTO scrive (isbnlibro, edizionelibro, codautore) VALUES ('".$Isbn."','".$Edizione."','".$Autore."')";
$query_resA = pg_query($con, $queryA);

$queryA1 = "INSERT INTO scrive (isbnlibro, edizionelibro, codautore) VALUES ('".$Isbn."','".$Edizione."','".$Autore1."')";
$query_resA1 = pg_query($con, $queryA1);

$queryA2 = "INSERT INTO scrive (isbnlibro, edizionelibro, codautore) VALUES ('".$Isbn."','".$Edizione."','".$Autore2."')";
$query_resA2 = pg_query($con, $queryA2);

$queryA3 = "INSERT INTO scrive (isbnlibro, edizionelibro, codautore) VALUES ('".$Isbn."','".$Edizione."','".$Autore3."')";
$query_resA3 = pg_query($con, $queryA3);

$queryA4 = "INSERT INTO scrive (isbnlibro, edizionelibro, codautore) VALUES ('".$Isbn."','".$Edizione."','".$Autore4."')";
$query_resA4 = pg_query($con, $queryA4);

	
while ($NCopie > 0) {
	$queryB = "INSERT INTO copia (sezione, scaffale, edizionelibro, isbnlibro, datareg) VALUES ('".$Sez."','".$Scaf."','".$Edizione."','".$Isbn."',CURRENT_DATE)";
