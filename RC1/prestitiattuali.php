  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        $query_prestiti = "SELECT * FROM prestito p JOIN copia c ON p.nRegCopia=c.nReg JOIN libro l ON c.edizioneLibro=l.edizione AND c.isbnLibro=l.isbn WHERE dataInizio IS NOT NULL AND dataFine IS null ";

        $query_prestiti_res = pg_query($con, $query_prestiti);

        if(!query_prestiti_res){
          echo "Errore nella query: ".query_prestiti;
          exit();
        }

        if (pg_fetch_array($query_prestiti_res)) {
          ...
          echo "\n\t\t<td><b>termina prestito</b></td>";

          echo "\n\t</thead></tr>";

          while($row = pg_fetch_assoc($query_prestiti_res)) {
            echo "\n\t<tbody><tr>";
            ...
            echo "\n\t\t<td><a href='terminaprestito.php?Mail=".$Mail."&NReg=".$NReg."'>TERMINA PRESTITO</a></td>";
